...
const token_classifier_1 = require("../core/token_classifier");
...
function classifiedToResult(classified) {
...
function inspectToken(token, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const classified = (0, token_classifier_1.classifyToken)(trimmed);
        const result = classifiedToResult(classified);
        if ((options === null || options === void 0 ? void 0 : options.check) && trimmed.startsWith('gh')) {
            result.details = yield checkGitHubToken(trimmed);
        }
        return result;
    });
}
function checkGitHubToken(token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const res = yield fetch('https://api.github.com/', {
...
function formatInspectResult(result) {
    ...
    lines.push('');
    if (((_a = result.details) === null || _a === void 0 ? void 0 : _a.scopes) && result.details.scopes.length > 0) {
        lines.push(`  Scopes: ${result.details.scopes.join(', ')}`);
    }
    if ((_b = result.details) === null || _b === void 0 ? void 0 : _b.expiration) {
        lines.push(`  Expiration: ${result.details.expiration}`);
    }
    if (((_c = result.details) === null || _c === void 0 ? void 0 : _c.scopes) || ((_d = result.details) === null || _d === void 0 ? void 0 : _d.expiration)) {
        lines.push('');
    }
